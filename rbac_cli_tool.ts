...
function addAccessOnResource(access: string, name: string): void {
  if (resources[name]) {
...
function addRole(roleName: string): void {
  if (!roles[roleName]) {
    roles[roleName] = {};
...
function addAccessOnResourceToRole(
  access: string,
  resourceName: string,
  roleName: string
): void {
...
function addRoleToUser(roleName: string, userName: string): void {
